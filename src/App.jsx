...
import { openTab, closeTab, advanceTab, changeTab } from '$state/tabsSlice.js';
...
function MenuItems() {
	...
	return (
		<>
			<MenuItem onAction={() => dispatch(openTab({ ...welcomeTab }))}>
				Open welcome tab
			</MenuItem>
			<MenuItem onAction={() => dispatch(openTab({ ...diagnosticsTab }))}>
				Show diagnostics
			</MenuItem>
			<Separator />
